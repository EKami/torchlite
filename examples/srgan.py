...
from torchlight.data.datasets.srgan import TrainDataset, AdvValDataset
...
def get_loaders(args, num_workers=os.cpu_count()):
    ...
    val_ds = AdvValDataset(tfiles.get_files(val_hr_path.absolute()),
                           args.upscale_factor)
...
def main(args):
    train_loader, adv_valid_loader = get_loaders(args)
    ...
    learner.train(optimizer_g, loss, None, args.gen_epochs, train_loader, adv_valid_loader, callbacks)
